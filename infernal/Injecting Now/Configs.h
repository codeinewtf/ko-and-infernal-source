namespace ColorPicker {
	...
	Color BoxVisible{ 58, 214, 0, 255 };// ColorPicker::Test
	bool BoxVisBool = false;
	bool BoxRGBBool = false;

	Color BoxInVisible{ 230, 31, 0, 255 };// ColorPicker::Test
	...
	bool MovmentRGBBool = false;

	Color Fov{ 255, 80, 180,255 };// ColorPicker::Test
	bool FovBool = false;
