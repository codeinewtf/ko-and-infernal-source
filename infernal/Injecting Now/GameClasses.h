...
namespace Classes
{
	...
	auto LoadFromMemory_Internal = reinterpret_cast<DWORD64(*)(DWORD64)>(Il2cpp::resolve_icall(_("UnityEngine.AssetBundle::LoadFromMemory_Internal()")));
	...
	void InitClasses()
	{
		...
		LoadFromMemory_Internal = reinterpret_cast<DWORD64(*)(DWORD64)>(Il2cpp::resolve_icall(_("UnityEngine.AssetBundle::LoadFromMemory_Internal()")));
